        ...
        return Column(
          children: [
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[1]['widget']),
                  Expanded(child: _videoViews[2]['widget']),
                ],
              ),
            ),
            SizedBox(
                height: getScreenHeight() / 2.5,
                child: _videoViews[0]['widget']),
          ],
        );
      case 4:
        return Column(
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[3]['widget']),
                  Expanded(child: _videoViews[0]['widget']),
                ],
              ),
            ),
          ],
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[4]['widget']),
                  Expanded(child: _videoViews[0]['widget']),
                ],
              ),
            ),
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[5]['widget']),
                  Expanded(child: _videoViews[0]['widget']),
                ],
              ),
            ),
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[4]['widget']),
                  Expanded(child: _videoViews[5]['widget']),
                  Expanded(child: _videoViews[6]['widget']),
                ],
              ),
            ),
            Expanded(
        ...
        return Column(
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[7]['widget']),
                  Expanded(child: _videoViews[0]['widget']),
                ],
              ),
            ),
          ...
          children: [
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[7]['widget']),
                  Expanded(child: _videoViews[8]['widget']),
                  Expanded(child: _videoViews[0]['widget']),
                ],
              ),
            ),
            ...
            Expanded(
              child: Row(
                children: [
                  Expanded(child: _videoViews[7]['widget']),
                  Expanded(child: _videoViews[8]['widget']),
                  Expanded(child: _videoViews[9]['widget']),
                ],
              ),
            ),
            Expanded(
